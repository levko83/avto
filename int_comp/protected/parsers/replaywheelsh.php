...
class replaywheelsh
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=10;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'replaywheelsh'.DIRECTORY_SEPARATOR.$filename;
       ...
       // $currency_value=1/$currency;
        if ($this->price_identity=="fdbb87a203bf9d17a41e3b1ed07ad340")
        {
            for ($r=11; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>10,'com_prod_ident'=>$com_prod_ident);
