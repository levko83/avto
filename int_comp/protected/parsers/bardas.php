...
class bardas
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=48;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'bardas'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="96efefc2f32e4f02cfbda07cb085efcb")
        {
            ...
            for ($r=4; $r <= $this->lastRow; $r++)
            {
                ...
                $price_t=$this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(11,$r)->getValue();
                $price=ceil($price_t);
                ...
                {
                    $attr=array('company_id'=>48,'com_prod_ident'=>$com_prod_ident);
