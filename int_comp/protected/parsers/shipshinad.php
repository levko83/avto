...
class shipshinad
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=56;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'shipshinad'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="44a848fc0e4147512fc4a0e629b30fe8")
        {
            ...
            for ($r=2; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>56,'com_prod_ident'=>$com_prod_ident);
