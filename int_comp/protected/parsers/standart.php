...
class standart
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=41;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'standart'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="8420d441fdd9952235d3f91408957f33")
        {
            ...
            for ($r=10; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>41,'com_prod_ident'=>$com_prod_ident);
