...
class tairland
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=42;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'tairland'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="7e8d44d325b950249fb6719f2a9b8288")
        {
            for ($r=14; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>42,'com_prod_ident'=>$com_prod_ident);
