...
class avtopilotd
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=59;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'avtopilotd'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="e38a102f05a047f5a4bdf7c86e783154" && trim($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(5,4)->getValue())=='$')
        {
            for ($r=5; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>59,'com_prod_ident'=>$com_prod_ident);
