...
class topgummarketz
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=12;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'topgummarketz'.DIRECTORY_SEPARATOR.$filename;
       ...
       // $currency_value=1/$currency;
        if ($this->price_identity=="7e7facdac11b9096e9b67f317d654b2b")
        {
            for ($r=1; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>12,'com_prod_ident'=>$com_prod_ident);
