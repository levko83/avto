...
class replaywheelshz
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=14;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'replaywheelshz'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="fdbb87a203bf9d17a41e3b1ed07ad340")
        {
            for ($r=11; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>14,'com_prod_ident'=>$com_prod_ident);
