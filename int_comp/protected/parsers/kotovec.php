...
class kotovec
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=51;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'kotovec'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        $this->price_identity.=trim($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(2,2)->getValue());
        ...
        if ($this->price_identity=="7507a75b5cf733faa9caab5dc4c69333")
        {
            ...
            for ($r=3; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>51,'com_prod_ident'=>$com_prod_ident);
