...
class shipshinash
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=55;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'shipshinash'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="4e14661435bc44da720de45a3ad5237b")
        {
            ...
            for ($r=2; $r <= $this->lastRow; $r++)
            {
                ...
                if ($com_prod_ident=='') {$com_prod_ident=trim($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(4,$r)->getValue());}

                $prod_name=trim($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(4,$r)->getValue());
                ...
                {
                    $attr=array('company_id'=>55,'com_prod_ident'=>$com_prod_ident);
