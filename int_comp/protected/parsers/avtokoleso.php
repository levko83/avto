...
class avtokoleso
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=3;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'avtokoleso'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="c07e3c23e3cbb785988aa07276d7e01c")
        {
            for ($r=19; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>3,'com_prod_ident'=>$com_prod_ident);
