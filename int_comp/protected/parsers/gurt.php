...
class gurt
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=29;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'gurt'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
       ...
       //$this->price_identity.=($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(1,2)->getValue());
        ...
        if (strlen($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(6,6)->getValue())<1&&strlen($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(6,7)->getValue())<1)
        {
        ...
        if ($this->price_identity==true)
        {
            for ($i=0;$i<3;$i++)
            {
                ...
                {
                    $com_prod_ident=$this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(1,$r)->getValue().' '.$this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(2,$r)->getValue().' '.$this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(3,$r)->getValue();
                    ...
                    {
                        $attr=array('company_id'=>29,'com_prod_ident'=>$com_prod_ident);
