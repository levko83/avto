...
class shinteh
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=45;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'shinteh'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="cd78f9623ec514da9461729b0d44a6aa")
        {
            ...
            for ($r=10; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>45,'com_prod_ident'=>$com_prod_ident);
            ...
            for ($r=10; $r <= $this->lastRow; $r++)
            {
                ...
                $com_prod_ident=trim($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(0,$r)->getValue());
                $prod_name=trim($this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(1,$r)->getValue().' '.$this->objPHPExcel->getActiveSheet()->getCellByColumnAndRow(3,$r)->getValue());
