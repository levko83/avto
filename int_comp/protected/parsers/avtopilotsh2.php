...
class avtopilotsh2
{
    ...
    {
        self::$data=null;
        self::$data['company_id']=62;
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'int_comp'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'avtopilotsh2'.DIRECTORY_SEPARATOR.$filename;
    ...
    private function startParse()
    {
        ...
        if ($this->price_identity=="dd807ba05926ee914fafe2126273c5bf")
        {
            for ($r=8; $r <= $this->lastRow; $r++)
            {
                ...
                {
                    $attr=array('company_id'=>62,'com_prod_ident'=>$com_prod_ident);
