...
class Pricelist extends CActiveRecord
{
    ...
    public function beforeSave()
    {
        ...
        {                        
            $file_directory=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'parser'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.$this->parse_class;
    ...
    {
        require_once($_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'parser'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'parsers'.DIRECTORY_SEPARATOR.$parse_class.'.php');
