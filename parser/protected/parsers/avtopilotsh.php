...
class avtopilotsh
{
    ...
    public function __construct($filename)
    {
        ...
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'parser'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'avtopilotsh'.DIRECTORY_SEPARATOR.$filename;
