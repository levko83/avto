...
class vito
{
    ...
    public function __construct($filename)
    {
        ...
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'parser'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'vito'.DIRECTORY_SEPARATOR.$filename;
