...
class avtopilotl
{
    ...
    public function __construct($filename)
    {
        ...
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'parser'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'avtopilotl'.DIRECTORY_SEPARATOR.$filename;
