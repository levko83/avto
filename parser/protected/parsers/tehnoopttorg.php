...
class tehnoopttorg
{
    ...
    public function __construct($filename)
    {
        ...
        $this->filename=$_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'parser'.DIRECTORY_SEPARATOR.'protected'.DIRECTORY_SEPARATOR.'prices'.DIRECTORY_SEPARATOR.'tehnoopttorg'.DIRECTORY_SEPARATOR.$filename;
