...
class FilterTires{
    ...
    public function __construct($filter){
       ...
       Yii::log(print_r($filter));

       $base = new CBaseFilter("shinsIndex", $filter);
//       $base->addFilterPrice("v1", "v2", "price");
//       $base->addFilterItem("v3", "shins_diametr");
//       $base->addFilterItem("v7", "shins_run_flat_technology_id");
//       $base->addFilterItem("v10", "shins_type_of_avto_id", "shins_type_of_avto");
//       $base->addFilterItem("v11", "vendor_id", "vendor_name");
//       $base->addCheckBoxesFields("shins_run_flat_technology_id");
//       $base->buildVocabs();
       ...
       echo "<pre>";
       var_dump($base->shins_run_flat_technology_id);
       //var_dump($base->_sphinxQueryResult["shins_diametr"]);

        //var_dump($base->vendor_id);
        //var_dump($base->shins_type_of_avto_id);
...
//            }
    ...
    private function _prepareSphinxListData($match, $key_field, $value_field, $asUrlValue = FALSE){
        ...
        foreach($match as $item){
            ...
            if($asUrlValue){
                ...
                $href = Yii::app()->createUrl("tires/index", $filter);
                $v = CHtml::link($v, $href);
            }
            //-----------------------
    ...
    public function getVocabulary($field_name, $asUrlValue = FALSE){
        if($field_name == "price"){
        ...
        if($field_name == "shins_diametr"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_diametr"], "shins_diametr", "shins_diametr", $asUrlValue
            );
        }
        if($field_name == "shins_load_index"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_load_index"], "shins_load_index_translit", "shins_load_index", $asUrlValue
            );
        }
        if($field_name == "shins_profile_height"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_profile_height"], "shins_profile_height", "shins_profile_height", $asUrlValue
            );
        }
        if($field_name == "shins_profile_width"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_profile_width"], "shins_profile_width", "shins_profile_width", $asUrlValue
            );
        }
        if($field_name == "shins_season_id"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_season_id"], "shins_season_id", "shins_season", $asUrlValue
            );
        }
        if($field_name == "shins_type_of_avto_id"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_type_of_avto_id"], "shins_type_of_avto_id", "shins_type_of_avto", $asUrlValue
            );
        }
        if($field_name == "shins_run_flat_technology_id"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_run_flat_technology_id"], "shins_run_flat_technology_id", "shins_run_flat_technology_id", $asUrlValue
            );
        }
        if($field_name == "shins_spike_id"){
            return $this->_prepareSphinxListData(
                $this->_result["shins_spike_id"], "shins_spike_id", "shins_spike_id", $asUrlValue
            );
        }
        if($field_name == "vendor_id"){
            return $this->_prepareSphinxListData(
                $this->_result["vendor_id"], "vendor_id", "vendor_name", $asUrlValue
            );
        }
        return null;
    }
