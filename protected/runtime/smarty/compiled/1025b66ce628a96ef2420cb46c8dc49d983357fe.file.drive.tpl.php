<?php /* Smarty version Smarty-3.1.15, created on 2014-05-26 19:46:11
         compiled from "/var/www/ponzps26/data/www/new.extraload.com.ua/protected/views/drives/drive.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4419651052f245a6672fb6-92140254%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1025b66ce628a96ef2420cb46c8dc49d983357fe' => 
    array (
      0 => '/var/www/ponzps26/data/www/new.extraload.com.ua/protected/views/drives/drive.tpl',
      1 => 1400681435,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4419651052f245a6672fb6-92140254',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_52f245a6857e58_47805482',
  'variables' => 
  array (
    'this' => 0,
    'display' => 0,
...
<?php if ($_valid && !is_callable('content_52f245a6857e58_47805482')) {function content_52f245a6857e58_47805482($_smarty_tpl) {?><?php if (!is_callable('smarty_function_imageResizer')) include '/var/www/ponzps26/data/www/new.extraload.com.ua/protected/vendor/Smarty/plugins/function.imageResizer.php';
    ...
    <div id="squeeze">
        <div class="products node node-10 clearfix">
            ...
            <div class="field field-name-title">
                <h1>Диски <?php echo $_smarty_tpl->tpl_vars['display']->value->display_name;?>
</h1>
            </div>
...
?>
                                <a href="/images/products/disks/<?php echo $_smarty_tpl->tpl_vars['image']->value["imageName"];?>
" data-lightbox="photo">
                                    <img class="source-image" src="<?php echo smarty_function_imageResizer(array('product_type'=>"drive",'imageName'=>$_smarty_tpl->tpl_vars['image']->value["imageName"],'width'=>180,'height'=>230),$_smarty_tpl);?>
" alt="">
                                </a>
                            <?php } ?>
                        </div>
...
?>
                                <?php if ($_smarty_tpl->tpl_vars['i']->value<4) {?>
                                    <li><a href="#"><img src="<?php echo smarty_function_imageResizer(array('product_type'=>"drive",'imageName'=>$_smarty_tpl->tpl_vars['image']->value["imageName"],'width'=>47,'height'=>47),$_smarty_tpl);?>
" alt=""></a></li>
                                <?php }?>
                            <?php } ?>
                        </ul>
...
?>
 ...
 $_from = $_smarty_tpl->tpl_vars['disks_data']->value[$_smarty_tpl->tpl_vars['diametr']->value]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["v"]->key => $_smarty_tpl->tpl_vars["v"]->value) {
$_smarty_tpl->tpl_vars["v"]->_loop = true;
?>
                                            <tr>
                                                <td class="element-0">
                                                    <?php echo $_smarty_tpl->tpl_vars['v']->value["psd"];?>

                                                </td>
                                                <td class="element-1">
                                                    <?php if ($_smarty_tpl->tpl_vars['v']->value["disks_rim_diametr"]>0) {?>
                                                        <?php echo round($_smarty_tpl->tpl_vars['v']->value["disks_rim_diametr"],1);?>

                                                    <?php }?>
                                                </td>
                                                <td class="element-2">
                                                    <?php if ($_smarty_tpl->tpl_vars['v']->value["disks_boom"]>0) {?>
                                                        <?php echo round($_smarty_tpl->tpl_vars['v']->value["disks_boom"],1);?>

                                                    <?php }?>
                                                </td>
                                                <td class="element-3">
                                                    <?php if ($_smarty_tpl->tpl_vars['v']->value["disks_fixture_port_diametr"]>0) {?>
                                                        <?php echo round($_smarty_tpl->tpl_vars['v']->value["disks_fixture_port_diametr"],1);?>

                                                    <?php }?>
                                                </td>
                                                <td class="element-4">
                                                    <?php echo $_smarty_tpl->tpl_vars['v']->value["disks_color"];?>
 ...
 грн.
                                                ...
                                                <td class="element-7 add-drive">
                                                    <?php if ($_smarty_tpl->tpl_vars['v']->value["amount"]>4) {?>
                                                        <a href="#" drive-id="<?php echo $_smarty_tpl->tpl_vars['v']->value["id"];?>
">Купить</a>
                                                    <?php }?>
                                                </td>
                                                <td class="element-8" >
                                                    <?php if ($_smarty_tpl->tpl_vars['v']->value["amount"]>4) {?>
                                                        <input type="text" class="drives_count" drive-id="<?php echo $_smarty_tpl->tpl_vars['v']->value["id"];?>
" value="4"> шт.
                                                    <?php }?>
                                                </td>
                                            </tr>
