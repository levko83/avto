...
/**
 * This is the model class for table "disks_type".
 *
 * The followings are the available columns in table 'disks_type':
 * @property integer $id
 ...
 */
class DisksType extends CExtendedActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'disks' => array(self::HAS_MANY, 'Disks', 'disks_type_id'),
		);
	}
	 ...
	 * @return DisksType the static model class
	 */
