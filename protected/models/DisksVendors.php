...
/**
 * This is the model class for table "disks_vendors".
 *
 * The followings are the available columns in table 'disks_vendors':
 * @property integer $id
 ...
 */
class DisksVendors extends CExtendedActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'disks' => array(self::HAS_MANY, 'Disks', 'vendor_id'),
		);
	}
	 ...
	 * @return DisksVendors the static model class
	 */
