...
/**
 * This is the model class for table "shins_params".
 *
 * The followings are the available columns in table 'shins_params':
 * @property integer $id
 ...
 * @property string $ref
 */
class ShinsParams extends CExtendedActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('filter_widget', 'length', 'max'=>10),
	 ...
	 * @return ShinsParams the static model class
	 */
