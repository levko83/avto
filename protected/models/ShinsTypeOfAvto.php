...
/**
 * This is the model class for table "shins_type_of_avto".
 *
 * The followings are the available columns in table 'shins_type_of_avto':
 * @property integer $id
 ...
 */
class ShinsTypeOfAvto extends CExtendedActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'shins' => array(self::HAS_MANY, 'Shins', 'shins_type_of_avto_id'),
		);
	}
	 ...
	 * @return ShinsTypeOfAvto the static model class
	 */
